...
```
    ...
    c. Data berisi Nama negara bagian, singkatan dari nama negara bagian, wilayah negara bagian,
       dan populasi negara bagian serta jumlah total pembunuhan pada tahun 2010.
    d. `str` tidak menunjukkan informasi yang relevan.
Dari pernyataan diatas dapat disimpulkan bahwa ***Opsi C*** merupakan pernyataan yang paling menggambarkan karakter tiap variabel pada *data frame*.
